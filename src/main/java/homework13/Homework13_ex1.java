...
public class Homework13_ex1 {
    public static void main(String[] args) {
     ...
     //   long start=System.currentTimeMillis();
        try(Reader in =new BufferedReader(new FileReader("C:\\Users\\Radu\\IdeaProjects\\algorithms\\src\\main.resources\\Java_wiki.txt"));
            Writer out=new BufferedWriter(new FileWriter("C:\\Users\\Radu\\IdeaProjects\\algorithms\\src\\main.resources\\output.txt"))){
